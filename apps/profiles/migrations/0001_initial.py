# Generated by Django 3.2.7 on 2024-09-04 15:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(default='+8801991290120', max_length=30, region=None, verbose_name='Phone Number')),
                ...
                ('country', django_countries.fields.CountryField(default='BN', max_length=2, verbose_name='Country')),
                ('city', models.CharField(blank=True, default='Dhaka', max_length=180, null=True, verbose_name='City')),
                ...
                ('is_agent', models.BooleanField(default=False, help_text='Are you an agent?', verbose_name='Agnet')),
                ...
                ('num_reviews', models.IntegerField(blank=True, default=0, null=True, verbose_name='Number of Ratings')),
