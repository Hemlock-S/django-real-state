...
class Profile(TimeStampUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("Phone Number"), max_length=30, default="+8801991290120")
    ...
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Dhaka", blank=True, null=True)
    ...
    is_agent = models.BooleanField(verbose_name=_("Agnet"), default=False, help_text=_("Are you an agent?"))
    ...
    num_reviews = models.IntegerField(verbose_name=_("Number of Ratings"), default=0, blank=True, null=True)
